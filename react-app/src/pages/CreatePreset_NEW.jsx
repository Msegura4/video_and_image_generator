        ...
        <div className="two-col">
          ...
          <div>
            ...
            {type === 'image' && (
              <>
                <div className="section">
                  <div className="section-label">Style visuel</div>
                  <div className="field">
                ...
                <div className="section">
                  <div className="section-label">Caméra</div>
                ...
                <div className="section">
                  <div className="section-label">Composition & Lumière</div>
                  <div className="field">
                ...
                <div className="section">
                  <div className="section-label">Prompt négatif & mots-clés</div>
                  <div className="field">
            ...
            {type === 'img2video' && (
              <>
                <div className="section">
                  <div className="section-label">Prompt de mouvement</div>
                  <div className="field">
                ...
                <div className="section">
                  <div className="section-label">Paramètres recommandés</div>
                  <div className="field-row">
                    <div className="field">
            ...
            {type === 'extendvideo' && (
              <>
                <div className="section">
                  <div className="section-label">Prompt de continuation</div>
                  <div className="field">
